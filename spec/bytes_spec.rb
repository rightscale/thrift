...
describe Thrift::Bytes do
  if RUBY_VERSION >= '1.9'
    describe '.empty_byte_buffer' do
      ...
      it 'creates an empty buffer of given size' do
    ...
    describe '.set_string_byte' do
      it 'sets byte value at index' do
        s = "\x41\x42"
    ...
    describe '.convert_to_utf8_byte_buffer' do
      it 'converts UTF-8 String to byte buffer' do
      ...
      it 'converts ISO-8859-15 String to UTF-8 byte buffer' do
        # Assumptions
    ...
    describe '.convert_to_string' do
      it 'converts UTF-8 byte buffer to a UTF-8 String' do
